<template>
	<div class="module">
		<VHeader title="Register。" subtitle="Pursue your object, be it what it will, steadily and indefatigably." />
		<div class="module-content login-content">
			<ElForm label-position="top">
				...
				<ElFormItem>
					<div class="fr-lr">
						<ElCheckbox v-model="options.isMemento"><p class="notes">一周内免登陆</p></ElCheckbox>
						<RouterLink to="/sign/login"><p class="notes">已有账号?</p></RouterLink>
					</div>
				</ElFormItem>
				<ElFormItem>
					<div class="center">
